...
iptables-nft -C FORWARD -i eth0 -o wlan1 -m state --state RELATED,ESTABLISHED -j ACCEPT || iptables-nft -A FORWARD -i eth0 -o wlan1 -m state --state RELATED,ESTABLISHED -j ACCEPT

iptables-nft -C FORWARD -i wlan1 -o eth0 -j ACCEPT || iptables-nft -A FORWARD -i wlan1 -o eth0 -j ACCEPT
